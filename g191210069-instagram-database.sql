...
CREATE TABLE public."Close Friends" (
    ...
    "closefriendsID" integer NOT NULL
);
...
--
-- Name: Close Friends_closefriends_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public."Close Friends" ALTER COLUMN "closefriendsID" ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public."Close Friends_closefriends_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: Close Friends_closefriends_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public."Close Friends_closefriends_id_seq"', 1, false);
...
ALTER TABLE ONLY public."Close Friends"
    ADD CONSTRAINT "Close Friends_pkey" PRIMARY KEY ("closefriendsID");
...
ALTER TABLE ONLY public."Comment"
    ADD CONSTRAINT "lnk_Post_Comment" FOREIGN KEY ("Post_id") REFERENCES public."Post"("Post_id") MATCH FULL ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public."Like"
    ADD CONSTRAINT "lnk_Post_Like" FOREIGN KEY ("postID") REFERENCES public."Post"("Post_id") MATCH FULL ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public."UserPost"
    ADD CONSTRAINT "lnk_Post_UserPost" FOREIGN KEY ("userPostID") REFERENCES public."Post"("Post_id") MATCH FULL ON UPDATE CASCADE ON DELETE CASCADE;
